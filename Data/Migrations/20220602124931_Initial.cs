    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GearsBoxTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearFactury = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Generations_BrandModels_BrandModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Modifications_BodyTypes_BodyTypeId",
                        column: x => x.BodyTypeId,
                        principalTable: "BodyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Modifications_EngineModels_EngineModelId",
                        column: x => x.EngineModelId,
                        principalTable: "EngineModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Modifications_GearsBoxTypes_GearBoxTypeId",
                        column: x => x.GearBoxTypeId,
                        principalTable: "GearsBoxTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Modifications_BodyTypeId",
                table: "Modifications",
                column: "BodyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Modifications_EngineModelId",
                table: "Modifications",
                column: "EngineModelId");

            migrationBuilder.CreateIndex(
                name: "IX_Modifications_GearBoxTypeId",
                table: "Modifications",
                column: "GearBoxTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Modifications_GenerationId",
                table: "Modifications",
                column: "GenerationId");
        }
